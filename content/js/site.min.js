if (document.addEventListener("DOMContentLoaded", function() {
    objectFitImages();
    var t = document.getElementById("my-accessible-dialog"), e = document.getElementById("main");
    new window.A11yDialog(t, e).on("show", function(t, e) {
        console.log(t), console.log(e);
    });
}), jQuery(document).ready(function(e) {
    e(".favorite").on("click", function(t) {
        t.preventDefault(), e(this).toggleClass("enabled");
    });
    ...
    "use strict";
    function e(t, e) {
        this._show = this.show.bind(this), this._hide = this.hide.bind(this), this._maintainFocus = this._maintainFocus.bind(this), 
        this._bindKeypress = this._bindKeypress.bind(this), this.container = t, this.dialog = t.querySelector('dialog, [role="dialog"], [role="alertdialog"]'), 
        this.role = this.dialog.getAttribute("role") || "dialog", this.useDialog = "show" in document.createElement("dialog") && "DIALOG" === this.dialog.nodeName, 
    ...
    function i(t, e) {
        return n((e || document).querySelectorAll(t));
    }
    function o(t) {
        var e = r(t), n = t.querySelector("[autofocus]") || e[0];
        n && n.focus();
    }
    function r(t) {
        return i(a.join(","), t).filter(function(t) {
            return !!(t.offsetWidth || t.offsetHeight || t.getClientRects().length);
        });
    }
    var s, a = [ 'a[href]:not([tabindex^="-"]):not([inert])', 'area[href]:not([tabindex^="-"]):not([inert])', "input:not([disabled]):not([inert])", "select:not([disabled]):not([inert])", "textarea:not([disabled]):not([inert])", "button:not([disabled]):not([inert])", 'iframe:not([tabindex^="-"]):not([inert])', 'audio:not([tabindex^="-"]):not([inert])', 'video:not([tabindex^="-"]):not([inert])', '[contenteditable]:not([tabindex^="-"]):not([inert])', '[tabindex]:not([tabindex^="-"]):not([inert])' ];
    e.prototype.create = function(t) {
        return this._targets = this._targets || function(t) {
            return NodeList.prototype.isPrototypeOf(t) ? n(t) : Element.prototype.isPrototypeOf(t) ? [ t ] : "string" == typeof t ? i(t) : void 0;
        }(t) || function(t) {
            var e = n(t.parentNode.childNodes).filter(function(t) {
                return 1 === t.nodeType;
            });
            return e.splice(e.indexOf(t), 1), e;
        }(this.container), this.shown = this.dialog.hasAttribute("open"), this.dialog.setAttribute("role", this.role), 
        this.useDialog ? this.container.setAttribute("data-a11y-dialog-native", "") : this.shown ? this.container.removeAttribute("aria-hidden") : this.container.setAttribute("aria-hidden", !0), 
        this._openers = i('[data-a11y-dialog-show="' + this.container.id + '"]'), this._openers.forEach(function(t) {
            t.addEventListener("click", this._show);
        }.bind(this)), this._closers = i("[data-a11y-dialog-hide]", this.container).concat(i('[data-a11y-dialog-hide="' + this.container.id + '"]')), 
        this._closers.forEach(function(t) {
            t.addEventListener("click", this._hide);
        }.bind(this)), this._fire("create"), this;
    }, e.prototype.show = function(t) {
        return this.shown || (this.shown = !0, s = document.activeElement, this.useDialog ? this.dialog.showModal(t instanceof Event ? void 0 : t) : (this.dialog.setAttribute("open", ""), 
        this.container.removeAttribute("aria-hidden"), this._targets.forEach(function(t) {
            t.setAttribute("aria-hidden", "true");
        })), o(this.dialog), document.body.addEventListener("focus", this._maintainFocus, !0), 
        document.addEventListener("keydown", this._bindKeypress), this._fire("show", t)), 
        this;
    }, e.prototype.hide = function(t) {
        return this.shown && (this.shown = !1, this.useDialog ? this.dialog.close(t instanceof Event ? void 0 : t) : (this.dialog.removeAttribute("open"), 
        this.container.setAttribute("aria-hidden", "true"), this._targets.forEach(function(t) {
            t.removeAttribute("aria-hidden");
        })), s && s.focus(), document.body.removeEventListener("focus", this._maintainFocus, !0), 
        document.removeEventListener("keydown", this._bindKeypress), this._fire("hide", t)), 
        this;
        ...
        return void 0 === this._listeners[t] && (this._listeners[t] = []), this._listeners[t].push(e), 
        this;
    }, e.prototype.off = function(t, e) {
        var n = this._listeners[t].indexOf(e);
        return -1 < n && this._listeners[t].splice(n, 1), this;
    }, e.prototype._fire = function(t, e) {
        (this._listeners[t] || []).forEach(function(t) {
            t(this.container, e);
        }.bind(this));
    }, e.prototype._bindKeypress = function(t) {
        this.shown && 27 === t.which && "alertdialog" !== this.role && (t.preventDefault(), 
        this.hide()), this.shown && 9 === t.which && function(t, e) {
            var n = r(t), i = n.indexOf(document.activeElement);
            e.shiftKey && 0 === i ? (n[n.length - 1].focus(), e.preventDefault()) : e.shiftKey || i !== n.length - 1 || (n[0].focus(), 
            e.preventDefault());
        }(this.dialog, t);
    }, e.prototype._maintainFocus = function(t) {
        this.shown && !this.container.contains(t.target) && o(this.dialog);
    }, "undefined" != typeof module && void 0 !== module.exports ? module.exports = e : "function" == typeof define && define.amd ? define("A11yDialog", [], function() {
        return e;
    }) : "object" == typeof t && (t.A11yDialog = e);
}("undefined" != typeof global ? global : window), "undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");
...
!function() {
    ...
    function s(o) {
        return this.each(function() {
            var t = f(this), e = t.data("bs.carousel"), n = f.extend({}, d.DEFAULTS, t.data(), "object" == typeof o && o), i = "string" == typeof o ? o : n.slide;
            e || t.data("bs.carousel", e = new d(this, n)), "number" == typeof o ? e.to(o) : i ? e[i]() : n.interval && e.pause().cycle();
        });
    }
    function d(t, e) {
        this.$element = f(t), this.$indicators = this.$element.find(".carousel-indicators"), 
    ...
    d.VERSION = "3.3.7", d.TRANSITION_DURATION = 600, d.DEFAULTS = {
        ...
        return t || (this.paused = !1), this.interval && clearInterval(this.interval), this.options.interval && !this.paused && (this.interval = setInterval(f.proxy(this.next, this), this.options.interval)), 
        this;
        ...
        return t || (this.paused = !0), this.$element.find(".next, .prev").length && f.support.transition && (this.$element.trigger(f.support.transition.end), 
        ...
        if (this.$element.trigger(l), !l.isDefaultPrevented()) {
            ...
            return f.support.transition && this.$element.hasClass("slide") ? (i.addClass(t), 
    ...
    function e(t) {
        var e, n = f(this), i = f(n.attr("data-target") || (e = n.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""));
        if (i.hasClass("carousel")) {
            var o = f.extend({}, i.data(), n.data()), r = n.attr("data-slide-to");
    ...
    m.VERSION = "3.3.7", m.TRANSITION_DURATION = 150, m.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (a) {
                var f = r, d = this.getPosition(this.$viewport);
                r = "bottom" == r && l.bottom + u > d.bottom ? "top" : "top" == r && l.top - u < d.top ? "bottom" : "right" == r && l.right + c > d.width ? "left" : "left" == r && l.left - c < d.left ? "right" : r, 
        ...
        var u = /top|bottom/.test(e), f = u ? 2 * c.left - i + a : 2 * c.top - o + l, d = u ? "offsetWidth" : "offsetHeight";
        n.offset(t), this.replaceArrow(f, n[0][d], u);
    ...
    "use strict";
    function o(t, e) {
        this.$body = r(document.body), this.$scrollElement = r(r(t).is(document.body) ? window : t), 
    ...
    var c = function(t, e) {
        this.options = l.extend({}, c.DEFAULTS, e), this.$target = l(this.options.target).on("scroll.bs.affix.data-api", l.proxy(this.checkPosition, this)).on("click.bs.affix.data-api", l.proxy(this.checkPositionWithEventLoop, this)), 
    ...
    "use strict";
    var e = [], E = C.document, i = Object.getPrototypeOf, a = e.slice, g = e.concat, l = e.push, o = e.indexOf, n = {}, r = n.toString, h = n.hasOwnProperty, s = h.toString, c = s.call(Object), m = {};
    function v(t, e) {
    ...
    k.fn = k.prototype = {
        ...
        s !== (i = t[e]) && (c && i && (k.isPlainObject(i) || (o = Array.isArray(i))) ? (r = o ? (o = !1, 
        n && Array.isArray(n) ? n : []) : n && k.isPlainObject(n) ? n : {}, s[e] = k.extend(c, r, i)) : void 0 !== i && (s[e] = i));
        return s;
    }, k.extend({
        ...
        isPlainObject: function(t) {
            var e, n;
            return !(!t || "[object Object]" !== r.call(t) || (e = i(t)) && ("function" != typeof (n = h.call(e, "constructor") && e.constructor) || s.call(n) !== c));
        },
        ...
        camelCase: function(t) {
            return t.replace(d, "ms-").replace(p, u);
        },
        each: function(t, e) {
            var n, i = 0;
            if (y(t)) for (n = t.length; i < n && !1 !== e.call(t[i], i, t[i]); i++) ; else for (i in t) if (!1 === e.call(t[i], i, t[i])) break;
            return t;
        },
        trim: function(t) {
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (y(Object(t)) ? k.merge(n, "string" == typeof t ? [ t ] : t) : l.call(n, t)), 
            n;
        },
        ...
        map: function(t, e, n) {
            var i, o, r = 0, s = [];
            if (y(t)) for (i = t.length; r < i; r++) null != (o = e(t[r], r, n)) && s.push(o); else for (r in t) null != (o = e(t[r], r, n)) && s.push(o);
            return g.apply([], s);
        },
        guid: 1,
        proxy: function(t, e) {
            var n, i, o;
            if ("string" == typeof e && (n = t[e], e = t, t = n), k.isFunction(t)) return i = a.call(arguments, 2), 
            (o = function() {
    ...
    var b = function(n) {
        ...
        var t, p, x, r, s, h, d, g, w, l, c, T, C, a, E, m, u, v, y, k = "sizzle" + 1 * new Date(), b = n.document, S = 0, i = 0, $ = st(), A = st(), D = st(), N = function(t, e) {
            return t === e && (c = !0), 0;
        }, j = {}.hasOwnProperty, e = [], O = e.pop, L = e.push, _ = e.push, I = e.slice, R = function(t, e) {
            for (var n = 0, i = t.length; n < i; n++) if (t[n] === e) return n;
            return -1;
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", F = "\\[" + H + "*(" + q + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + q + "))|)" + H + "*\\]", M = ":(" + q + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", W = new RegExp(H + "+", "g"), B = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$", "g"), U = new RegExp("^" + H + "*," + H + "*"), z = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), V = new RegExp("=" + H + "*([^\\]'\"]*?)" + H + "*\\]", "g"), Q = new RegExp(M), X = new RegExp("^" + q + "$"), Y = {
            ID: new RegExp("^#(" + q + ")"),
            CLASS: new RegExp("^\\.(" + q + ")"),
            TAG: new RegExp("^(" + q + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, G = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, tt = /[+~]/, et = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)", "ig"), nt = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, it = function(t, e) {
        ...
        try {
            _.apply(e = I.call(b.childNodes), b.childNodes), e[b.childNodes.length].nodeType;
        } catch (t) {
            _ = {
        ...
        function rt(t, e, n, i) {
            var o, r, s, a, l, c, u, f = e && e.ownerDocument, d = e ? e.nodeType : 9;
            if (n = n || [], "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d) return n;
            if (!i && ((e ? e.ownerDocument || e : b) !== C && T(e), e = e || C, E)) {
                if (11 !== d && (l = Z.exec(t))) if (o = l[1]) {
                    if (9 === d) {
                        if (!(s = e.getElementById(o))) return n;
                        if (s.id === o) return n.push(s), n;
                    } else if (f && (s = f.getElementById(o)) && y(e, s) && s.id === o) return n.push(s), 
                    n;
                } else {
                    if (l[2]) return _.apply(n, e.getElementsByTagName(t)), n;
                    if ((o = l[3]) && p.getElementsByClassName && e.getElementsByClassName) return _.apply(n, e.getElementsByClassName(o)), 
                    n;
                }
                if (p.qsa && !D[t + " "] && (!m || !m.test(t))) {
                    if (1 !== d) f = e, u = t; else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(nt, it) : e.setAttribute("id", a = k), 
                        r = (c = h(t)).length; r--; ) c[r] = "#" + a + " " + vt(c[r]);
                        u = c.join(","), f = tt.test(t) && gt(e.parentNode) || e;
                    }
                    if (u) try {
                        return _.apply(n, f.querySelectorAll(u)), n;
                    } catch (t) {} finally {
        ...
        for (t in p = rt.support = {}, s = rt.isXML = function(t) {
            ...
            E = !s(C), b !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), 
            p.attributes = lt(function(t) {
            ...
            }, u = [], m = [], (p.qsa = J.test(C.querySelectorAll)) && (lt(function(t) {
                ...
                e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && m.push("name" + H + "*[*^$|!~]?="), 
            ...
            })), (p.matchesSelector = J.test(v = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector)) && lt(function(t) {
                p.disconnectedMatch = v.call(t, "*"), v.call(t, "[s!='']:x"), u.push("!=", M);
            }), m = m.length && new RegExp(m.join("|")), u = u.length && new RegExp(u.join("|")), 
            e = J.test(a.compareDocumentPosition), y = e || J.test(a.contains) ? function(t, e) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !p.sortDetached && e.compareDocumentPosition(t) === n ? t === C || t.ownerDocument === b && y(b, t) ? -1 : e === C || e.ownerDocument === b && y(b, e) ? 1 : l ? R(l, t) - R(l, e) : 0 : 4 & n ? -1 : 1);
            } : function(t, e) {
                if (t === e) return c = !0, 0;
                var n, i = 0, o = t.parentNode, r = e.parentNode, s = [ t ], a = [ e ];
                if (!o || !r) return t === C ? -1 : e === C ? 1 : o ? -1 : r ? 1 : l ? R(l, t) - R(l, e) : 0;
            ...
            if ((t.ownerDocument || t) !== C && T(t), e = e.replace(V, "='$1']"), p.matchesSelector && E && !D[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))) try {
                var n = v.call(t, e);
            ...
            var n = x.attrHandle[e.toLowerCase()], i = n && j.call(x.attrHandle, e.toLowerCase()) ? n(t, e, !E) : void 0;
            ...
            preFilter: {
                ATTR: function(t) {
                    return t[1] = t[1].replace(et, f), t[3] = (t[3] || t[4] || t[5] || "").replace(et, f), 
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return Y.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && Q.test(n) && (e = h(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), 
            ...
            filter: {
                ...
                CHILD: function(h, t, e, g, m) {
                    ...
                    return 1 === g && 0 === m ? function(t) {
                        ...
                        var i, o, r, s, a, l, c = v != y ? "nextSibling" : "previousSibling", u = t.parentNode, f = b && t.nodeName.toLowerCase(), d = !n && !b, p = !1;
                        if (u) {
                            if (v) {
                                for (;c; ) {
                            ...
                            if (l = [ y ? u.firstChild : u.lastChild ], y && d) {
                                for (p = (a = (i = (o = (r = (s = u)[k] || (s[k] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === S && i[1]) && i[2], 
                                s = a && u.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop(); ) if (1 === s.nodeType && ++p && s === t) {
                                    o[h] = [ S, a, p ];
                                    break;
                                }
                            } else if (d && (p = a = (i = (o = (r = (s = t)[k] || (s[k] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === S && i[1]), 
                            !1 === p) for (;(s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++p || (d && ((o = (r = s[k] || (s[k] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] = [ S, p ]), 
                            s !== t)); ) ;
                ...
                PSEUDO: function(t, r) {
                    ...
                    return s[k] ? s(r) : 1 < s.length ? (e = [ t, t, "", r ], x.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function(t, e) {
                        for (var n, i = s(t, r), o = i.length; o--; ) t[n = R(t, i[o])] = !(e[n] = i[o]);
                    }) : function(t) {
                        return s(t, 0, e);
                    }) : s;
                }
            ...
            pseudos: {
                ...
                contains: at(function(e) {
                    return e = e.replace(et, f), function(t) {
                        return -1 < (t.textContent || t.innerText || r(t)).indexOf(e);
                    };
                }),
                lang: at(function(n) {
                    return X.test(n || "") || rt.error("unsupported lang: " + n), n = n.replace(et, f).toLowerCase(), 
                    function(t) {
                        var e;
                        do {
        ...
        function yt(a, t, e) {
            ...
            return t.first ? function(t, e, n) {
                ...
                } else for (;t = t[l]; ) if (1 === t.nodeType || f) if (o = (r = t[k] || (t[k] = {}))[t.uniqueID] || (r[t.uniqueID] = {}), 
        ...
        function wt(p, h, g, m, v, t) {
            return m && !m[k] && (m = wt(m)), v && !v[k] && (v = wt(v, t)), at(function(t, e, n, i) {
                var o, r, s, a = [], l = [], c = e.length, u = t || function(t, e, n) {
                    ...
                    return n;
                }(h || "*", n.nodeType ? [ n ] : n, []), f = !p || !t && h ? u : xt(u, a, p, n, i), d = g ? v || (t ? p : c || m) ? [] : e : f;
                if (g && g(f, d, n, i), m) for (o = xt(d, l), m(o, [], n, i), r = o.length; r--; ) (s = o[r]) && (d[l[r]] = !(f[l[r]] = s));
                if (t) {
                    if (v || p) {
                        if (v) {
                        ...
                        for (r = d.length; r--; ) (s = d[r]) && -1 < (o = v ? R(t, s) : a[r]) && (t[o] = !(e[o] = s));
                    }
                } else d = xt(d === e ? d.splice(c, d.length) : d), v ? v(null, e, d, i) : _.apply(e, d);
            });
        }
        function Tt(t) {
            for (var o, e, n, i = t.length, r = x.relative[t[0].type], s = r || x.relative[" "], a = r ? 1 : 0, l = yt(function(t) {
                ...
                return o = null, i;
            } ]; a < i; a++) if (e = x.relative[t[a].type]) u = [ yt(bt(u), e) ]; else {
                if ((e = x.filter[t[a].type].apply(null, t[a].matches))[k]) {
                    ...
                    return wt(1 < a && bt(u), 1 < a && vt(t.slice(0, a - 1).concat({
                        value: " " === t[a - 2].type ? "*" : ""
                    })).replace(B, "$1"), e, a < n && Tt(t.slice(a, n)), n < i && Tt(t = t.slice(n)), n < i && vt(t));
                }
                u.push(e);
            }
            return bt(u);
        ...
        return mt.prototype = x.filters = x.pseudos, x.setFilters = new mt(), h = rt.tokenize = function(t, e) {
            ...
            for (s = t, a = [], l = x.preFilter; s; ) {
                ...
                n = !1, (i = z.exec(s)) && (n = i.shift(), o.push({
                    value: n,
                    type: i[0].replace(B, " ")
                }), s = s.slice(n.length)), x.filter) !(i = Y[r].exec(s)) || l[r] && !(i = l[r](i)) || (n = i.shift(), 
                o.push({
                    value: n,
                    type: r,
                    matches: i
            ...
            var n, i = [], o = [], r = D[t + " "];
            if (!r) {
                for (n = (e = e || h(t)).length; n--; ) (r = Tt(e[n]))[k] ? i.push(r) : o.push(r);
                (r = D(t, function(m, v) {
                    function t(t, e, n, i, o) {
                        var r, s, a, l = 0, c = "0", u = t && [], f = [], d = w, p = t || b && x.find.TAG("*", o), h = S += null == d ? 1 : Math.random() || .1, g = p.length;
                        for (o && (w = e === C || e || o); c !== g && null != (r = p[c]); c++) {
                            if (b && r) {
                                for (s = 0, e || r.ownerDocument === C || (T(r), n = !E); a = m[s++]; ) if (a(r, e || C, n)) {
                                    i.push(r);
                                    break;
                                }
                                o && (S = h);
                        ...
                        if (l += c, y && c !== l) {
                            for (s = 0; a = v[s++]; ) a(u, f, e, n);
                            if (t) {
                                if (0 < l) for (;c--; ) u[c] || f[c] || (f[c] = O.call(i));
                                f = xt(f);
                            }
                            _.apply(i, f), o && !t && 0 < f.length && 1 < l + v.length && rt.uniqueSort(i);
                        }
                        return o && (S = h, w = d), u;
                    }
            ...
            if (n = n || [], 1 === u.length) {
                if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === e.nodeType && E && x.relative[r[1].type]) {
                    if (!(e = (x.find.ID(s.matches[0].replace(et, f), e) || [])[0])) return n;
                    c && (e = e.parentNode), t = t.slice(r.shift().value.length);
                }
                for (o = Y.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]); ) if ((l = x.find[a]) && (i = l(s.matches[0].replace(et, f), tt.test(r[0].type) && gt(e.parentNode) || e))) {
                    if (r.splice(o, 1), !(t = i.length && vt(r))) return _.apply(n, i), n;
                    break;
                }
            }
            return (c || d(t, u))(i, e, !E, n, !e || tt.test(t) && gt(e.parentNode) || e), n;
        }, p.sortStable = k.split("").sort(N).join("") === k, p.detectDuplicates = !!c, 
        T(), p.sortDetached = lt(function(t) {
    ...
    function D(t, n, i) {
        ...
        }) : A.test(n) ? k.filter(n, t, i) : (n = k.filter(n, t), k.grep(t, function(t) {
    ...
    k.filter = function(t, e, n) {
        ...
        is: function(t) {
            return !!D(this, "string" == typeof t && T.test(t) ? k(t) : t || [], !1).length;
        }
    });
    var N, j = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (k.fn.init = function(t, e, n) {
        var i, o;
        if (!t) return this;
        if (n = n || N, "string" != typeof t) return t.nodeType ? (this[0] = t, this.length = 1, 
        this) : k.isFunction(t) ? void 0 !== n.ready ? n.ready(t) : t(k) : k.makeArray(t, this);
        if (!(i = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [ null, t, null ] : j.exec(t)) || !i[1] && e) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
        if (i[1]) {
            if (e = e instanceof k ? e[0] : e, k.merge(this, k.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : E, !0)), 
            $.test(i[1]) && k.isPlainObject(e)) for (i in e) k.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this;
        }
    ...
    k.fn.extend({
        ...
        closest: function(t, e) {
            var n, i = 0, o = this.length, r = [], s = "string" != typeof t && k(t);
            if (!T.test(t)) for (;i < o; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (s ? -1 < s.index(n) : 1 === n.nodeType && k.find.matchesSelector(n, t))) {
                r.push(n);
                break;
            }
        ...
        k.fn[i] = function(t, e) {
            ...
            return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = k.filter(e, n)), 
            1 < this.length && (L[i] || k.uniqueSort(n), O.test(i) && n.reverse()), this.pushStack(n);
        };
    });
    var I = /[^\x20\t\r\n\f]+/g;
    function R(t) {
    ...
    function H(t, e, n, i) {
        var o;
        try {
            t && k.isFunction(o = t.promise) ? o.call(t).done(e).fail(n) : t && k.isFunction(o = t.then) ? o.call(t, e, n) : e.apply(void 0, [ t ].slice(i));
        } catch (t) {
            n.apply(void 0, [ t ]);
        }
    }
    k.Callbacks = function(i) {
        i = "string" == typeof i ? function(t) {
            var n = {};
            return k.each(t.match(I) || [], function(t, e) {
                n[e] = !0;
            }), n;
        }(i) : k.extend({}, i);
        function n() {
            for (r = r || i.once, e = o = !0; a.length; l = -1) for (t = a.shift(); ++l < s.length; ) !1 === s[l].apply(t[0], t[1]) && i.stopOnFalse && (l = s.length, 
            t = !1);
        ...
        var o, t, e, r, s = [], a = [], l = -1, c = {
            add: function() {
                return s && (t && !o && (l = s.length - 1, a.push(t)), function n(t) {
                    k.each(t, function(t, e) {
                        k.isFunction(e) ? i.unique && c.has(e) || s.push(e) : e && e.length && "string" !== k.type(e) && n(e);
                    });
                }(arguments), t && !o && n()), this;
            },
            remove: function() {
                return k.each(arguments, function(t, e) {
                    for (var n; -1 < (n = k.inArray(e, s, n)); ) s.splice(n, 1), n <= l && l--;
                }), this;
            },
            has: function(t) {
            ...
            fireWith: function(t, e) {
                return r || (e = [ t, (e = e || []).slice ? e.slice() : e ], a.push(e), o || n()), 
                this;
            },
            fire: function() {
                ...
                pipe: function() {
                    ...
                    return k.Deferred(function(i) {
                        k.each(r, function(t, e) {
                            var n = k.isFunction(o[e[4]]) && o[e[4]];
                            a[e[1]](function() {
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    e = t && ("object" == typeof t || "function" == typeof t) && t.then, k.isFunction(e) ? a ? e.call(t, c(l, r, R, a), c(l, r, P, a)) : (l++, 
                                    e.call(t, c(l, r, R, a), c(l, r, P, a), c(l, r, R, r.notifyWith))) : (s !== R && (n = void 0, 
                            ...
                            var n = this, i = arguments, e = a ? t : function() {
                                try {
                                    ...
                                    k.Deferred.exceptionHook && k.Deferred.exceptionHook(t, e.stackTrace), l <= o + 1 && (s !== P && (n = void 0, 
                                    i = [ t ]), r.rejectWith(n, i));
                                }
                            };
                            o ? e() : (k.Deferred.getStackHook && (e.stackTrace = k.Deferred.getStackHook()), 
                            C.setTimeout(e));
                        };
                    }
                    return k.Deferred(function(t) {
                        r[0][3].add(c(0, t, k.isFunction(i) ? i : R, t.notifyWith)), r[1][3].add(c(0, t, k.isFunction(e) ? e : R)), 
                        r[2][3].add(c(0, t, k.isFunction(n) ? n : P));
                    }).promise();
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            if (n <= 1 && (H(t, s.done(e(i)).resolve, s.reject, !n), "pending" === s.state() || k.isFunction(r[i] && r[i].then))) return s.then();
            for (;i--; ) H(r[i], e(i), s.reject);
            return s.promise();
        }
    });
    ...
    var F = k.Deferred();
    function M() {
        E.removeEventListener("DOMContentLoaded", M), C.removeEventListener("load", M), 
        k.ready();
    }
    k.fn.ready = function(t) {
        ...
        readyWait: 1,
        ready: function(t) {
            (!0 === t ? --k.readyWait : k.isReady) || ((k.isReady = !0) !== t && 0 < --k.readyWait || F.resolveWith(E, [ k ]));
        }
    }), k.ready.then = F.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? C.setTimeout(k.ready) : (E.addEventListener("DOMContentLoaded", M), 
    ...
    var B = function(t, e, n, i, o, r, s) {
        ...
        if ("object" === k.type(n)) for (a in o = !0, n) B(t, e, a, n[a], !0, r, s); else if (void 0 !== i && (o = !0, 
        k.isFunction(i) || (s = !0), c && (e = s ? (e.call(t, i), null) : (c = e, function(t, e, n) {
            return c.call(k(t), n);
    ...
    U.uid = 1, U.prototype = {
        ...
        set: function(t, e, n) {
            ...
            if ("string" == typeof e) o[k.camelCase(e)] = n; else for (i in e) o[k.camelCase(i)] = e[i];
            return o;
        },
        get: function(t, e) {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    n = (e = Array.isArray(e) ? e.map(k.camelCase) : (e = k.camelCase(e)) in i ? [ e ] : e.match(I) || []).length;
                    for (;n--; ) delete i[e[n]];
                }
    ...
    var z = new U(), V = new U(), Q = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, X = /[A-Z]/g;
    function Y(t, e, n) {
        var i;
        if (void 0 === n && 1 === t.nodeType) if (i = "data-" + e.replace(X, "-$&").toLowerCase(), 
    ...
    k.extend({
        ...
        data: function(n, t) {
            ...
            if (void 0 !== n) return "object" == typeof n ? this.each(function() {
                ...
                var e;
                if (r && void 0 === t) {
                    if (void 0 !== (e = V.get(r, n))) return e;
                    if (void 0 !== (e = Y(r, n))) return e;
                } else this.each(function() {
                    V.set(this, n, t);
                });
            }, null, t, 1 < arguments.length, null, !0);
            if (this.length && (o = V.get(r), 1 === r.nodeType && !z.get(r, "hasDataAttrs"))) {
                for (e = s.length; e--; ) s[e] && (0 === (i = s[e].name).indexOf("data-") && (i = k.camelCase(i.slice(5)), 
                Y(r, i, o[i])));
        ...
        queue: function(t, e, n) {
            var i;
            if (t) return e = (e || "fx") + "queue", i = z.get(t, e), n && (!i || Array.isArray(n) ? i = z.access(t, e, k.makeArray(n)) : i.push(n)), 
            i || [];
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--; ) (i = z.get(s[a], t + "queueHooks")) && i.empty && (o++, 
            i.empty.add(n));
    ...
    var K = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, J = new RegExp("^(?:([+-])=|)(" + K + ")([a-z%]*)$", "i"), Z = [ "Top", "Right", "Bottom", "Left" ], tt = function(t, e) {
    ...
    function et(t, e, n, i) {
        var o, r = 1, s = 20, a = i ? function() {
            ...
            return k.css(t, e, "");
        }, l = a(), c = n && n[3] || (k.cssNumber[e] ? "" : "px"), u = (k.cssNumber[e] || "px" !== c && +l) && J.exec(k.css(t, e));
        if (u && u[3] !== c) for (c = c || u[3], n = n || [], u = +l || 1; u /= r = r || ".5", 
        k.style(t, e, u + c), r !== (r = a() / l) && 1 !== r && --s; ) ;
    ...
    function it(t, e) {
        ...
        e ? ("none" === n && (o[r] = z.get(i, "display") || null, o[r] || (i.style.display = "")), 
        "" === i.style.display && tt(i) && (o[r] = (f = c = l = void 0, c = (a = i).ownerDocument, 
        u = a.nodeName, (f = nt[u]) || (l = c.body.appendChild(c.createElement(u)), f = k.css(l, "display"), 
        l.parentNode.removeChild(l), "none" === f && (f = "block"), nt[u] = f)))) : "none" !== n && (o[r] = "none", 
        z.set(i, "display", n)));
        var a, l, c, u, f;
    ...
    var ot = /^(?:checkbox|radio)$/i, rt = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, st = /^$|\/(?:java|ecma)script/i, at = {
    ...
    function pt(t, e, n, i, o) {
        for (var r, s, a, l, c, u, f = e.createDocumentFragment(), d = [], p = 0, h = t.length; p < h; p++) if ((r = t[p]) || 0 === r) if ("object" === k.type(r)) k.merge(d, r.nodeType ? [ r ] : r); else if (dt.test(r)) {
            for (s = s || f.appendChild(e.createElement("div")), a = (rt.exec(r) || [ "", "" ])[1].toLowerCase(), 
            l = at[a] || at._default, s.innerHTML = l[1] + k.htmlPrefilter(r) + l[2], u = l[0]; u--; ) s = s.lastChild;
            k.merge(d, s.childNodes), (s = f.firstChild).textContent = "";
        } else d.push(e.createTextNode(r));
        for (f.textContent = "", p = 0; r = d[p++]; ) if (i && -1 < k.inArray(r, i)) o && o.push(r); else if (c = k.contains(r.ownerDocument, r), 
        s = lt(f.appendChild(r), "script"), c && ct(s), n) for (u = 0; r = s[u++]; ) st.test(r.type || "") && n.push(r);
        return f;
    }
    ut = E.createDocumentFragment().appendChild(E.createElement("div")), (ft = E.createElement("input")).setAttribute("type", "radio"), 
    ft.setAttribute("checked", "checked"), ft.setAttribute("name", "t"), ut.appendChild(ft), 
    ...
    var ht = E.documentElement, gt = /^key/, mt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, vt = /^([^.]*)(?:\.(.+)|)/;
    function yt() {
        return !0;
    }
    function bt() {
    ...
    function wt(t, e, n, i, o, r) {
        ...
        i = void 0) : (o = i, i = n, n = void 0)), !1 === o) o = bt; else if (!o) return t;
    ...
    k.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, f, d, p, h, g, m = z.get(e);
            if (m) for (n.handler && (n = (r = n).handler, o = r.selector), o && k.find.matchesSelector(ht, o), 
            n.guid || (n.guid = k.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                return void 0 !== k && k.event.triggered !== t.type ? k.event.dispatch.apply(e, arguments) : void 0;
            }), c = (t = (t || "").match(I) || [ "" ]).length; c--; ) p = g = (a = vt.exec(t[c]) || [])[1], 
            h = (a[2] || "").split(".").sort(), p && (f = k.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, 
            f = k.event.special[p] || {}, u = k.extend({
                type: p,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: h.join(".")
            }, r), (d = l[p]) || ((d = l[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(p, s)), 
            f.add && (f.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), 
            k.event.global[p] = !0);
        },
        remove: function(t, e, n, i, o) {
            var r, s, a, l, c, u, f, d, p, h, g, m = z.hasData(t) && z.get(t);
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(I) || [ "" ]).length; c--; ) if (p = g = (a = vt.exec(e[c]) || [])[1], 
                h = (a[2] || "").split(".").sort(), p) {
                    for (f = k.event.special[p] || {}, d = l[p = (i ? f.delegateType : f.bindType) || p] || [], 
                    a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--; ) u = d[r], 
                    !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(r, 1), 
                    u.selector && d.delegateCount--, f.remove && f.remove.call(t, u));
                    s && !d.length && (f.teardown && !1 !== f.teardown.call(t, h, m.handle) || k.removeEvent(t, p, m.handle), 
                    delete l[p]);
        ...
        dispatch: function(t) {
            var e, n, i, o, r, s, a = k.event.fix(t), l = new Array(arguments.length), c = (z.get(this, "events") || {})[a.type] || [], u = k.event.special[a.type] || {};
            for (l[0] = a, e = 1; e < arguments.length; e++) l[e] = arguments[e];
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = k.event.handlers.call(this, a, c), e = 0; (o = s[e++]) && !a.isPropagationStopped(); ) for (a.currentTarget = o.elem, 
                n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); ) a.rnamespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, 
                a.data = r.data, void 0 !== (i = ((k.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), 
                a.stopPropagation()));
        ...
        handlers: function(t, e) {
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button)) for (;c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                for (r = [], s = {}, n = 0; n < l; n++) void 0 === s[o = (i = e[n]).selector + " "] && (s[o] = i.needsContext ? -1 < k(o, this).index(c) : k.find(o, this, null, [ c ]).length), 
                s[o] && r.push(i);
                r.length && a.push({
                    elem: c,
                    handlers: r
        ...
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? yt : bt, 
        ...
        stopImmediatePropagation: function() {
            var t = this.originalEvent;
            this.isImmediatePropagationStopped = yt, t && !this.isSimulated && t.stopImmediatePropagation(), 
        ...
        k.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return n && (n === this || k.contains(this, n)) || (t.type = i.origType, e = i.handler.apply(this, arguments), 
                t.type = o), e;
            }
        };
    }), k.fn.extend({
    ...
    var Tt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, Ct = /<script|<style|<link/i, Et = /checked\s*(?:[^=]|=\s*.checked.)/i, kt = /^true\/(.*)/, St = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    function $t(t, e) {
    ...
    function Nt(t, e) {
        var n, i, o, r, s, a, l, c;
        if (1 === e.nodeType) {
            if (z.hasData(t) && (r = z.access(t), s = z.set(e, r), c = r.events)) for (o in delete s.handle, 
            s.events = {}, c) for (n = 0, i = c[o].length; n < i; n++) k.event.add(e, o, c[o][n]);
            V.hasData(t) && (a = V.access(t), l = k.extend({}, a), V.set(e, l));
        }
    }
    function jt(n, i, o, r) {
        i = g.apply([], i);
        var t, e, s, a, l, c, u = 0, f = n.length, d = f - 1, p = i[0], h = k.isFunction(p);
        if (h || 1 < f && "string" == typeof p && !m.checkClone && Et.test(p)) return n.each(function(t) {
            var e = n.eq(t);
            h && (i[0] = p.call(this, t, e.html())), jt(e, i, o, r);
        });
        if (f && (e = (t = pt(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), 
        e || r)) {
            for (a = (s = k.map(lt(t, "script"), At)).length; u < f; u++) l = t, u !== d && (l = k.clone(l, !0, !0), 
            a && k.merge(s, lt(l, "script"))), o.call(n[u], l, u);
            if (a) for (c = s[s.length - 1].ownerDocument, k.map(s, Dt), u = 0; u < a; u++) l = s[u], 
            st.test(l.type || "") && !z.access(l, "globalEval") && k.contains(c, l) && (l.src ? k._evalUrl && k._evalUrl(l.src) : v(l.textContent.replace(St, ""), c));
        }
        return n;
    }
    function Ot(t, e, n) {
        for (var i, o = e ? k.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || k.cleanData(lt(i)), 
        i.parentNode && (n && k.contains(i.ownerDocument, i) && ct(lt(i, "script")), i.parentNode.removeChild(i));
        return t;
    }
    k.extend({
        ...
        clone: function(t, e, n) {
            var i, o, r, s, a, l, c, u = t.cloneNode(!0), f = k.contains(t.ownerDocument, t);
            if (!(m.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || k.isXMLDoc(t))) for (s = lt(u), 
            i = 0, o = (r = lt(t)).length; i < o; i++) a = r[i], l = s[i], void 0, "input" === (c = l.nodeName.toLowerCase()) && ot.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e) if (n) for (r = r || lt(t), s = s || lt(u), i = 0, o = r.length; i < o; i++) Nt(r[i], s[i]); else Nt(t, u);
            return 0 < (s = lt(u, "script")).length && ct(s, !f && lt(t, "script")), u;
        },
        cleanData: function(t) {
            for (var e, n, i, o = k.event.special, r = 0; void 0 !== (n = t[r]); r++) if (W(n)) {
                if (e = n[z.expando]) {
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++) 1 === t.nodeType && (k.cleanData(lt(t, !1)), 
            t.textContent = "");
            return this;
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return B(this, function(t) {
                ...
                if ("string" == typeof t && !Ct.test(t) && !at[(rt.exec(t) || [ "", "" ])[1].toLowerCase()]) {
                    t = k.htmlPrefilter(t);
                    try {
                        for (;n < i; n++) 1 === (e = this[n] || {}).nodeType && (k.cleanData(lt(e, !1)), 
                        e.innerHTML = t);
                        e = 0;
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return jt(this, arguments, function(t) {
                ...
                k.inArray(this, n) < 0 && (k.cleanData(lt(this)), e && e.replaceChild(t, this));
            }, n);
        }
    }), k.each({
        appendTo: "append",
        ...
        k.fn[t] = function(t) {
            for (var e, n = [], i = k(t), o = i.length - 1, r = 0; r <= o; r++) e = r === o ? this : this.clone(!0), 
            k(i[r])[s](e), l.apply(n, e.get());
            return this.pushStack(n);
        };
    });
    var Lt, _t, It, Rt, Pt, Ht, qt = /^margin/, Ft = new RegExp("^(" + K + ")(?!px)[a-z%]+$", "i"), Mt = function(t) {
    ...
    function Wt() {
        if (Ht) {
            ...
            Ht.innerHTML = "", ht.appendChild(Pt);
            var t = C.getComputedStyle(Ht);
            Lt = "1%" !== t.top, Rt = "2px" === t.marginLeft, _t = "4px" === t.width, Ht.style.marginRight = "50%", 
            It = "4px" === t.marginRight, ht.removeChild(Pt), Ht = null;
        }
    }
    function Bt(t, e, n) {
        var i, o, r, s, a = t.style;
        return (n = n || Mt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || k.contains(t.ownerDocument, t) || (s = k.style(t, e)), 
        !m.pixelMarginRight() && Ft.test(s) && qt.test(e) && (i = a.width, o = a.minWidth, 
    ...
    Pt = E.createElement("div"), (Ht = E.createElement("div")).style && (Ht.style.backgroundClip = "content-box", 
    Ht.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === Ht.style.backgroundClip, 
    Pt.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", 
    Pt.appendChild(Ht), k.extend(m, {
    ...
    var zt = /^(none|table(?!-c[ea]).+)/, Vt = /^--/, Qt = {
        ...
        letterSpacing: "0",
        fontWeight: "400"
    }, Yt = [ "Webkit", "Moz", "ms" ], Gt = E.createElement("div").style;
    function Kt(t) {
        var e = k.cssProps[t];
    ...
    function Zt(t, e, n, i, o) {
        var r, s = 0;
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2) "margin" === n && (s += k.css(t, n + Z[r], !0, o)), 
        i ? ("content" === n && (s -= k.css(t, "padding" + Z[r], !0, o)), "margin" !== n && (s -= k.css(t, "border" + Z[r] + "Width", !0, o))) : (s += k.css(t, "padding" + Z[r], !0, o), 
        "padding" !== n && (s += k.css(t, "border" + Z[r] + "Width", !0, o)));
        return s;
    }
    function te(t, e, n) {
        var i, o = Mt(t), r = Bt(t, e, o), s = "border-box" === k.css(t, "boxSizing", !1, o);
        return Ft.test(r) ? r : (i = s && (m.boxSizingReliable() || r === t.style[e]), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), 
        (r = parseFloat(r) || 0) + Zt(t, e, n || (s ? "border" : "content"), i, o) + "px");
    }
    ...
    k.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = k.camelCase(e), l = Vt.test(e), c = t.style;
                return l || (e = Kt(a)), s = k.cssHooks[e] || k.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : c[e] : ("string" === (r = typeof n) && (o = J.exec(n)) && o[1] && (n = et(t, e, o), 
        ...
        css: function(t, e, n, i) {
            ...
            return Vt.test(e) || (e = Kt(a)), (s = k.cssHooks[e] || k.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), 
            void 0 === o && (o = Bt(t, e, i)), "normal" === o && e in Xt && (o = Xt[e]), "" === n || n ? (r = parseFloat(o), 
            !0 === n || isFinite(r) ? r || 0 : o) : o;
        }
    }), k.each([ "height", "width" ], function(t, s) {
        k.cssHooks[s] = {
            get: function(t, e, n) {
                if (e) return !zt.test(k.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? te(t, s, n) : G(t, Qt, function() {
                    return te(t, s, n);
                });
            },
            set: function(t, e, n) {
                var i, o = n && Mt(t), r = n && Zt(t, s, n, "border-box" === k.css(t, "boxSizing", !1, o), o);
                return r && (i = J.exec(e)) && "px" !== (i[3] || "px") && (t.style[s] = e, e = k.css(t, s)), 
                Jt(0, e, r);
            }
        };
    }), k.cssHooks.marginLeft = Ut(m.reliableMarginLeft, function(t, e) {
        if (e) return (parseFloat(Bt(t, "marginLeft")) || t.getBoundingClientRect().left - G(t, {
            marginLeft: 0
        }, function() {
        ...
        k.cssHooks[o + r] = {
            expand: function(t) {
                for (var e = 0, n = {}, i = "string" == typeof t ? t.split(" ") : [ t ]; e < 4; e++) n[o + Z[e] + r] = i[e] || i[e - 2] || i[0];
                return n;
            }
        }, qt.test(o) || (k.cssHooks[o + r].set = Jt);
    }), k.fn.extend({
        css: function(t, e) {
            return B(this, function(t, e, n) {
                var i, o, r = {}, s = 0;
                if (Array.isArray(e)) {
                    for (i = Mt(t), o = e.length; s < o; s++) r[e[s]] = k.css(t, e[s], !1, i);
                    return r;
                }
                return void 0 !== n ? k.style(t, e, n) : k.css(t, e);
            }, t, e, 1 < arguments.length);
        }
    }), ((k.Tween = ee).prototype = {
        constructor: ee,
        init: function(t, e, n, i, o, r) {
            this.elem = t, this.prop = n, this.easing = o || k.easing._default, this.options = e, 
        ...
        run: function(t) {
            ...
            n && n.set ? n.set(this) : ee.propHooks._default.set(this), this;
        }
    ...
    var ne, ie, oe, re, se = /^(?:toggle|show|hide)$/, ae = /queueHooks$/;
    function le() {
        ie && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(le) : C.setTimeout(le, k.fx.interval), 
        k.fx.tick());
    }
    function ce() {
    ...
    function de(r, t, e) {
        var n, s, i = 0, o = de.prefilters.length, a = k.Deferred().always(function() {
            delete l.elem;
        }), l = function() {
            if (s) return !1;
            for (var t = ne || ce(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, o = c.tweens.length; i < o; i++) c.tweens[i].run(n);
        ...
        for (function(t, e) {
            var n, i, o, r, s;
            for (n in t) if (o = e[i = k.camelCase(n)], r = t[n], Array.isArray(r) && (o = r[1], 
            r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = k.cssHooks[i]) && "expand" in s) for (n in r = s.expand(r), 
            delete t[i], r) n in t || (t[n] = r[n], e[n] = o); else e[i] = o;
        }(u, c.opts.specialEasing); i < o; i++) if (n = de.prefilters[i].call(c, r, u, c.opts)) return k.isFunction(n.stop) && (k._queueHooks(c.elem, c.opts.queue).stop = k.proxy(n.stop, n)), 
        n;
        return k.map(u, fe, c), k.isFunction(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), 
    ...
    k.Animation = k.extend(de, {
        ...
        tweener: function(t, e) {
            for (var n, i = 0, o = (t = k.isFunction(t) ? (e = t, [ "*" ]) : t.match(I)).length; i < o; i++) n = t[i], 
            de.tweeners[n] = de.tweeners[n] || [], de.tweeners[n].unshift(e);
        },
        prefilters: [ function(t, e, n) {
            var i, o, r, s, a, l, c, u, f = "width" in e || "height" in e, d = this, p = {}, h = t.style, g = t.nodeType && tt(t), m = z.get(t, "fxshow");
            ...
            if ((l = !k.isEmptyObject(e)) || !k.isEmptyObject(p)) for (i in f && 1 === t.nodeType && (n.overflow = [ h.overflow, h.overflowX, h.overflowY ], 
            null == (c = m && m.display) && (c = z.get(t, "display")), "none" === (u = k.css(t, "display")) && (c ? u = c : (it([ t ], !0), 
            c = t.style.display || c, u = k.css(t, "display"), it([ t ]))), ("inline" === u || "inline-block" === u && null != c) && "none" === k.css(t, "float") && (l || (d.done(function() {
                h.display = c;
            ...
            n.overflow && (h.overflow = "hidden", d.always(function() {
                ...
                display: c
            }), r && (m.hidden = !g), g && it([ t ], !0), d.done(function() {
                for (i in g || it([ t ]), z.remove(t, "fxshow"), p) k.style(t, i, p[i]);
        ...
        animate: function(e, t, n, i) {
            function o() {
                var t = de(this, k.extend({}, e), s);
                (r || z.get(this, "finish")) && t.stop(!0);
            }
            var r = k.isEmptyObject(e), s = k.speed(t, n, i);
        ...
        stop: function(o, t, r) {
            ...
            this.each(function() {
                var t = !0, e = null != o && o + "queueHooks", n = k.timers, i = z.get(this);
                if (e) i[e] && i[e].stop && s(i[e]); else for (e in i) i[e] && i[e].stop && ae.test(e) && s(i[e]);
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"), this.each(function() {
                var t, e = z.get(this), n = e[s + "queue"], i = e[s + "queueHooks"], o = k.timers, r = n ? n.length : 0;
                for (e.finish = !0, k.queue(this, s, []), i && i.stop && i.stop.call(this, !0), 
        ...
        for (ne = k.now(); e < n.length; e++) (t = n[e])() || n[e] !== t || n.splice(e--, 1);
    ...
    }, oe = E.createElement("input"), re = E.createElement("select").appendChild(E.createElement("option")), 
    oe.type = "checkbox", m.checkOn = "" !== oe.value, m.optSelected = re.selected, 
    (oe = E.createElement("input")).value = "t", oe.type = "radio", m.radioValue = "t" === oe.value;
    var pe, he = k.expr.attrHandle;
    k.fn.extend({
        attr: function(t, e) {
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? k.prop(t, e, n) : (1 === r && k.isXMLDoc(t) || (o = k.attrHooks[e.toLowerCase()] || (k.expr.match.bool.test(e) ? pe : void 0)), 
            void 0 !== n ? null === n ? void k.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), 
            n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = k.find.attr(t, e)) ? void 0 : i);
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        var s = he[e] || k.find.attr;
        he[e] = function(t, e, n) {
            var i, o, r = e.toLowerCase();
            return n || (o = he[r], he[r] = i, i = null != s(t, e, n) ? r : null, he[r] = o), 
            i;
        };
    });
    ...
    k.fn.extend({
        ...
        prop: function(t, e, n) {
            var i, o, r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && k.isXMLDoc(t) || (e = k.propFix[e] || e, 
        ...
        addClass: function(e) {
            ...
            if (k.isFunction(e)) return this.each(function(t) {
                k(this).addClass(e.call(this, t, ye(this)));
            });
            if ("string" == typeof e && e) for (t = e.match(I) || []; n = this[l++]; ) if (o = ye(n), 
            i = 1 === n.nodeType && " " + ve(o) + " ") {
        ...
        removeClass: function(e) {
            var t, n, i, o, r, s, a, l = 0;
            if (k.isFunction(e)) return this.each(function(t) {
                k(this).removeClass(e.call(this, t, ye(this)));
            });
        ...
        toggleClass: function(o, e) {
            var r = typeof o;
            return "boolean" == typeof e && "string" == r ? e ? this.addClass(o) : this.removeClass(o) : k.isFunction(o) ? this.each(function(t) {
                k(this).toggleClass(o.call(this, t, ye(this), e), e);
            }) : this.each(function() {
                var t, e, n, i;
                if ("string" == r) for (e = 0, n = k(this), i = o.match(I) || []; t = i[e++]; ) n.hasClass(t) ? n.removeClass(t) : n.addClass(t); else void 0 !== o && "boolean" != r || ((t = ye(this)) && z.set(this, "__className__", t), 
                this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : z.get(this, "__className__") || ""));
            });
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; ) if (1 === n.nodeType && -1 < (" " + ve(ye(n)) + " ").indexOf(e)) return !0;
            return !1;
        }
    });
    var be = /\r/g;
    k.fn.extend({
        val: function(n) {
            var i, t, o, e = this[0];
            return arguments.length ? (o = k.isFunction(n), this.each(function(t) {
                var e;
            ...
            })) : e ? (i = k.valHooks[e.type] || k.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value")) ? t : "string" == typeof (t = e.value) ? t.replace(be, "") : null == t ? "" : t : void 0;
        }
    }), k.extend({
        valHooks: {
            option: {
            ...
            select: {
                get: function(t) {
                    ...
                    for (i = r < 0 ? l : s ? r : 0; i < l; i++) if (((n = o[i]).selected || i === r) && !n.disabled && (!n.parentNode.disabled || !S(n.parentNode, "optgroup"))) {
                ...
                set: function(t, e) {
                    for (var n, i, o = t.options, r = k.makeArray(e), s = o.length; s--; ) ((i = o[s]).selected = -1 < k.inArray(k.valHooks.option.get(i), r)) && (n = !0);
    ...
    k.extend(k.event, {
        trigger: function(t, e, n, i) {
            var o, r, s, a, l, c, u, f = [ n || E ], d = h.call(t, "type") ? t.type : t, p = h.call(t, "namespace") ? t.namespace.split(".") : [];
            if (r = s = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !xe.test(d + k.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), 
            p.sort()), l = d.indexOf(":") < 0 && "on" + d, (t = t[k.expando] ? t : new k.Event(d, "object" == typeof t && t)).isTrigger = i ? 2 : 3, 
            t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, 
            t.result = void 0, t.target || (t.target = n), e = null == e ? [ t ] : k.makeArray(e, [ t ]), 
            u = k.event.special[d] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                if (!i && !u.noBubble && !k.isWindow(n)) {
                    for (a = u.delegateType || d, xe.test(a + d) || (r = r.parentNode); r; r = r.parentNode) f.push(r), 
                    s = r;
                    s === (n.ownerDocument || E) && f.push(s.defaultView || s.parentWindow || C);
                }
                for (o = 0; (r = f[o++]) && !t.isPropagationStopped(); ) t.type = 1 < o ? a : u.bindType || d, 
                (c = (z.get(r, "events") || {})[t.type] && z.get(r, "handle")) && c.apply(r, e), 
                (c = l && r[l]) && c.apply && W(r) && (t.result = c.apply(r, e), !1 === t.result && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), e) || !W(n) || l && k.isFunction(n[d]) && !k.isWindow(n) && ((s = n[l]) && (n[l] = null), 
                n[k.event.triggered = d](), k.event.triggered = void 0, s && (n[l] = s)), t.result;
            }
        },
        ...
        k.event.special[i] = {
            setup: function() {
                ...
                e || t.addEventListener(n, o, !0), z.access(t, i, (e || 0) + 1);
            },
            teardown: function() {
                var t = this.ownerDocument || this, e = z.access(t, i) - 1;
                e ? z.access(t, i, e) : (t.removeEventListener(n, o, !0), z.remove(t, i));
            }
        };
    });
    var we = C.location, Te = k.now(), Ce = /\?/;
    ...
    function Ae(n, t, i, o) {
        ...
        if (Array.isArray(t)) k.each(t, function(t, e) {
            i || Ee.test(n) ? o(n, e) : Ae(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, o);
        }); else if (i || "object" !== k.type(t)) o(n, t); else for (e in t) Ae(n + "[" + e + "]", t[e], i, o);
    }
    k.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !k(this).is(":disabled") && $e.test(this.nodeName) && !Se.test(t) && (this.checked || !ot.test(t));
            }).map(function(t, e) {
                var n = k(this).val();
    ...
    var De = /%20/g, Ne = /#.*$/, je = /([?&])_=[^&]*/, Oe = /^(.*?):[ \t]*([^\r\n]*)$/gm, Le = /^(?:GET|HEAD)$/, _e = /^\/\//, Ie = {}, Re = {}, Pe = "*/".concat("*"), He = E.createElement("a");
    function qe(r) {
        return function(t, e) {
            "string" != typeof t && (e = t, t = "*");
            var n, i = 0, o = t.toLowerCase().match(I) || [];
            if (k.isFunction(e)) for (;n = o[i++]; ) "+" === n[0] ? (n = n.slice(1) || "*", 
    ...
    He.href = we.href, k.extend({
        ...
        ajax: function(t, e) {
            ...
            var u, f, d, n, p, i, h, g, o, r, m = k.ajaxSetup({}, e), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? k(v) : k.event, b = k.Deferred(), x = k.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", T = {
                readyState: 0,
                getResponseHeader: function(t) {
                    var e;
                    if (h) {
                        if (!n) for (n = {}; e = Oe.exec(d); ) n[e[1].toLowerCase()] = e[2];
                        e = n[t.toLowerCase()];
                    }
                ...
                setRequestHeader: function(t, e) {
                    return null == h && (t = a[t.toLowerCase()] = a[t.toLowerCase()] || t, s[t] = e), 
                    this;
                },
                ...
                statusCode: function(t) {
                    var e;
                    if (t) if (h) T.always(t[T.status]); else for (e in t) w[e] = [ w[e], t[e] ];
                    return this;
                },
                abort: function(t) {
                    var e = t || l;
            ...
            if (b.promise(T), m.url = ((t || m.url || we.href) + "").replace(_e, we.protocol + "//"), 
            m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(I) || [ "" ], 
            null == m.crossDomain) {
                i = E.createElement("a");
                try {
                    i.href = m.url, i.href = i.href, m.crossDomain = He.protocol + "//" + He.host != i.protocol + "//" + i.host;
                } catch (t) {
                    m.crossDomain = !0;
                }
            }
            if (m.data && m.processData && "string" != typeof m.data && (m.data = k.param(m.data, m.traditional)), 
            Fe(Ie, m, e, T), h) return T;
            for (o in (g = k.event && m.global) && 0 == k.active++ && k.event.trigger("ajaxStart"), 
            m.type = m.type.toUpperCase(), m.hasContent = !Le.test(m.type), f = m.url.replace(Ne, ""), 
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(De, "+")) : (r = m.url.slice(f.length), 
            m.data && (f += (Ce.test(f) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (f = f.replace(je, "$1"), 
            r = (Ce.test(f) ? "&" : "?") + "_=" + Te++ + r), m.url = f + r), m.ifModified && (k.lastModified[f] && T.setRequestHeader("If-Modified-Since", k.lastModified[f]), 
            k.etag[f] && T.setRequestHeader("If-None-Match", k.etag[f])), (m.data && m.hasContent && !1 !== m.contentType || e.contentType) && T.setRequestHeader("Content-Type", m.contentType), 
            ...
            if (l = "abort", x.add(m.complete), T.done(m.success), T.fail(m.error), u = Fe(Re, m, e, T)) {
            ...
            function c(t, e, n, i) {
                var o, r, s, a, l, c = e;
                h || (h = !0, p && C.clearTimeout(p), u = void 0, d = i || "", T.readyState = 0 < t ? 4 : 0, 
                ...
                }(m, a, T, o), o ? (m.ifModified && ((l = T.getResponseHeader("Last-Modified")) && (k.lastModified[f] = l), 
                (l = T.getResponseHeader("etag")) && (k.etag[f] = l)), 204 === t || "HEAD" === m.type ? c = "nocontent" : 304 === t ? c = "notmodified" : (c = a.state, 
                r = a.data, o = !(s = a.error))) : (s = c, !t && c || (c = "error", t < 0 && (t = 0))), 
                T.status = t, T.statusText = (e || c) + "", o ? b.resolveWith(v, [ r, c, T ]) : b.rejectWith(v, [ T, c, s ]), 
                T.statusCode(w), w = void 0, g && y.trigger(o ? "ajaxSuccess" : "ajaxError", [ T, m, o ? r : s ]), 
                x.fireWith(v, [ T, c ]), g && (y.trigger("ajaxComplete", [ T, m ]), --k.active || k.event.trigger("ajaxStop")));
            }
            return T;
        },
    ...
    m.cors = !!Be && "withCredentials" in Be, m.ajax = Be = !!Be, k.ajaxTransport(function(o) {
        var r, s;
        if (m.cors || Be && !o.crossDomain) return {
            send: function(t, e) {
                ...
                r = function(t) {
                    return function() {
                        r && (r = s = i.onload = i.onerror = i.onabort = i.onreadystatechange = null, "abort" === t ? i.abort() : "error" === t ? "number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText) : e(We[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    k.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = ze.pop() || k.expando + "_" + Te++;
            return this[t] = !0, t;
        }
    }), k.ajaxPrefilter("json jsonp", function(t, e, n) {
        var i, o, r, s = !1 !== t.jsonp && (Ve.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Ve.test(t.data) && "data");
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = k.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, 
        ...
        t.converters["script json"] = function() {
            ...
            void 0 === o ? k(C).removeProp(i) : C[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, 
            ze.push(i)), r && k.isFunction(o) && o(r[0]), r = o = void 0;
        }), "script";
    }), m.createHTMLDocument = ((Ue = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 
    2 === Ue.childNodes.length), k.parseHTML = function(t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (m.createHTMLDocument ? ((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, 
        e.head.appendChild(i)) : e = E), r = !n && [], (o = $.exec(t)) ? [ e.createElement(o[1]) ] : (o = pt([ t ], e, r), 
        r && r.length && k(r).remove(), k.merge([], o.childNodes)));
        var i, o, r;
    }, k.fn.load = function(t, e, n) {
        var i, o, r, s = this, a = t.indexOf(" ");
        return -1 < a && (i = ve(t.slice(a)), t = t.slice(0, a)), k.isFunction(e) ? (n = e, 
        e = void 0) : e && "object" == typeof e && (o = "POST"), 0 < s.length && k.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function(t, e, n) {
            var i, o, r, s, a, l, c = k.css(t, "position"), u = k(t), f = {};
            "static" === c && (t.style.position = "relative"), a = u.offset(), r = k.css(t, "top"), 
            l = k.css(t, "left"), o = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (s = (i = u.position()).top, 
            i.left) : (s = parseFloat(r) || 0, parseFloat(l) || 0), k.isFunction(e) && (e = e.call(t, n, k.extend({}, a))), 
            null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + o), 
        ...
        offset: function(e) {
            ...
            return r ? r.getClientRects().length ? (i = r.getBoundingClientRect(), n = (t = r.ownerDocument).documentElement, 
            o = t.defaultView, {
        ...
        position: function() {
            if (this[0]) {
                ...
                e = this.offset(), S(t[0], "html") || (i = t.offset()), i = {
        ...
        k.fn[e] = function(t) {
            return B(this, function(t, e, n) {
                var i;
                return k.isWindow(t) ? i = t : 9 === t.nodeType && (i = t.defaultView), void 0 === n ? i ? i[o] : t[e] : void (i ? i.scrollTo(r ? i.pageXOffset : n, r ? n : i.pageYOffset) : t[e] = n);
            }, e, t, arguments.length);
        };
    }), k.each([ "top", "left" ], function(t, n) {
        k.cssHooks[n] = Ut(m.pixelPosition, function(t, e) {
            if (e) return e = Bt(t, n), Ft.test(e) ? k(t).position()[n] + "px" : e;
        });
    }), k.each({
        Height: "height",
        Width: "width"
        ...
        k.each({
            ...
            k.fn[r] = function(t, e) {
                ...
                return B(this, function(t, e, n) {
                    var i;
                    return k.isWindow(t) ? 0 === r.indexOf("outer") ? t["inner" + s] : t.document.documentElement["client" + s] : 9 === t.nodeType ? (i = t.documentElement, 
                    Math.max(t.body["scroll" + s], i["scroll" + s], t.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === n ? k.css(t, e, o) : k.style(t, e, n, o);
                }, a, n ? t : void 0, n);
            };
        });
    }), k.fn.extend({
    ...
    var Qe = C.jQuery, Xe = C.$;
    return k.noConflict = function(t) {
        return C.$ === k && (C.$ = Xe), t && C.jQuery === k && (C.jQuery = Qe), k;
    }, t || (C.jQuery = C.$ = k), k;
});
...
var objectFitImages = function() {
    ...
    function r(e) {
        var t = function(t) {
            for (var e, n = getComputedStyle(t).fontFamily, i = {}; null !== (e = l.exec(n)); ) i[e[1]] = e[2];
            return i;
        }(e), n = e[a];
        if (t["object-fit"] = t["object-fit"] || "fill", !n.img) {
            if ("fill" === t["object-fit"]) return;
            if (!n.skipTest && c && !t["object-position"]) return;
        }
        if (!n.img) {
            n.img = new Image(e.width, e.height), n.img.srcset = p.call(e, "data-ofi-srcset") || e.srcset, 
            n.img.src = p.call(e, "data-ofi-src") || e.src, h.call(e, "data-ofi-src", e.src), 
            e.srcset && h.call(e, "data-ofi-srcset", e.srcset), i(e, e.naturalWidth || e.width, e.naturalHeight || e.height), 
            e.srcset && (e.srcset = "");
            try {
                !function(n) {
                    var e = {
                        get: function(t) {
                            return n[a].img[t || "src"];
                        },
                        set: function(t, e) {
                            return n[a].img[e || "src"] = t, h.call(n, "data-ofi-" + e, t), r(n), t;
                        }
                    };
        ...
        })(n.img), e.style.backgroundImage = 'url("' + (n.img.currentSrc || n.img.src).replace(/"/g, '\\"') + '")', 
        e.style.backgroundPosition = t["object-position"] || "center", e.style.backgroundRepeat = "no-repeat", 
        e.style.backgroundOrigin = "content-box", /scale-down/.test(t["object-fit"]) ? o(n.img, function() {
    ...
    function s(t, e) {
        var n = !g && !t;
        if (e = e || {}, t = t || "img", u && !e.skipTest || !f) return !1;
        "img" === t ? t = document.getElementsByTagName("img") : "string" == typeof t ? t = document.querySelectorAll(t) : "length" in t || (t = [ t ]);
        for (var i = 0; i < t.length; i++) t[i][a] = t[i][a] || {
            skipTest: e.skipTest
        }, r(t[i]);
        ...
        }, !0), g = !0, t = "img"), e.watchMQ && window.addEventListener("resize", s.bind(null, t, {
            skipTest: e.skipTest
        }));
    }
    ...
    } : new Image(), c = "object-fit" in t.style, u = "object-position" in t.style, f = "background-size" in t.style, d = "string" == typeof t.currentSrc, p = t.getAttribute, h = t.setAttribute, g = !1;
    return s.supportsObjectFit = c, (s.supportsObjectPosition = u) || (HTMLImageElement.prototype.getAttribute = function(t) {
        return p.call(n(this, t), t);
    }, HTMLImageElement.prototype.setAttribute = function(t, e) {
        return h.call(n(this, t), t, String(e));
    }), s;
    function n(t, e) {
...
!function(f, d) {
    ...
    f.getComputedStyle ? (e = d.createElement("div"), [ "", "-webkit-", "-moz-", "-ms-" ].some(function(t) {
        try {
            e.style.position = t + "sticky";
        } catch (t) {}
        return "" != e.style.position;
    }) && (m = !0)) : m = !0;
    var v = "undefined" != typeof ShadowRoot, r = {
        top: null,
        left: null
    }, s = [], o = (t(n, [ {
        key: "refresh",
        value: function() {
            if (!m && !this._removed) {
                ...
                var t = this._node, e = getComputedStyle(t), n = {
                    top: e.top,
                    display: e.display,
                ...
                if (!isNaN(parseFloat(n.top)) && "table-cell" != n.display && "none" != n.display) {
                    this._active = !0;
                    var i = t.parentNode, o = v && i instanceof ShadowRoot ? i.host : i, r = t.getBoundingClientRect(), s = o.getBoundingClientRect(), a = getComputedStyle(o);
                    this._parent = {
                        node: o,
                        styles: {
                        ...
                        left: r.left,
                        right: d.documentElement.clientWidth - r.right
                    ...
                    var l = h(n.top);
                    this._limits = {
                        start: r.top + f.pageYOffset - l,
                        end: s.top + f.pageYOffset + o.offsetHeight - h(a.borderBottomWidth) - t.offsetHeight - l - h(n.marginBottom)
                    };
                    var c = a.position;
                    "absolute" != c && "relative" != c && (o.style.position = "relative"), this._recalcPosition();
                    var u = this._clone = {};
                    u.node = d.createElement("div"), p(u.node.style, {
                        ...
                        fontSize: "1em",
                        position: "static"
                    }), i.insertBefore(u.node, t), u.docOffsetTop = g(u.node);
                }
            }
        }
    }, {
        ...
        value: function() {
            ...
            delete this._clone, p(this._node.style, this._styles), delete this._styles, s.some(function(t) {
                return t !== e && t._parent && t._parent.node === e._parent.node;
            }) || p(this._parent.node.style, this._parent.styles), delete this._parent, this._stickyMode = null, 
        ...
        value: function() {
            var n = this;
            this._deactivate(), s.some(function(t, e) {
                if (t._node === n._node) return s.splice(e, 1), !0;
            }), this._removed = !0;
        }
    } ]), n), a = {
        stickies: s,
        ...
        addOne: function(t) {
            ...
            for (var e = 0; e < s.length; e++) if (s[e]._node === t) return s[e];
            return new o(t);
        },
        add: function(n) {
            if (n instanceof HTMLElement && (n = [ n ]), n.length) {
                for (var i = [], t = function(t) {
                    var e = n[t];
                    return e instanceof HTMLElement ? s.some(function(t) {
                        if (t._node === e) return i.push(t), !0;
                    }) ? "continue" : void i.push(new o(e)) : (i.push(void 0), "continue");
        ...
        remove: function(n) {
            if (n instanceof HTMLElement && (n = [ n ]), n.length) for (var t = function(t) {
                var e = n[t];
                s.some(function(t) {
                    if (t._node === e) return t.remove(), !0;
                });
    ...
    function n(e) {
        ...
        }(this, n), !(e instanceof HTMLElement)) throw new Error("First argument must be HTMLElement");
        if (s.some(function(t) {
            return t._node === e;
        })) throw new Error("Stickyfill is already applied to this node");
        this._node = e, this._stickyMode = null, this._active = !1, s.push(this), this.refresh();
    }
    m || function() {
        function t() {
            f.pageXOffset != r.left ? (r.top = f.pageYOffset, r.left = f.pageXOffset, a.refreshAll()) : f.pageYOffset != r.top && (r.top = f.pageYOffset, 
            r.left = f.pageXOffset, s.forEach(function(t) {
        ...
        t(), f.addEventListener("scroll", t), f.addEventListener("resize", a.refreshAll), 
        f.addEventListener("orientationchange", a.refreshAll);
        var n = void 0, i = void 0, o = void 0;
        "hidden" in d ? (i = "hidden", o = "visibilitychange") : "webkitHidden" in d && (i = "webkitHidden", 
        o = "webkitvisibilitychange"), o ? (d[i] || e(), d.addEventListener(o, function() {
            d[i] ? clearInterval(n) : e();
        })) : e();
    }(), "undefined" != typeof module && module.exports ? module.exports = a : f.Stickyfill = a;
}(window, document);